    ...
    <AuthContext.Provider value={authMethods}>
      <div className="min-h-screen bg-white font-body">
        <Routes>
          ...
          <Route path="/" element={<Layout><TaskList /></Layout>} />
          <Route path="/category/:categoryId" element={<Layout><CategoryView /></Layout>} />
          <Route path="/search" element={<Layout><SearchResults /></Layout>} />
          <Route path="/completed" element={<Layout><CompletedTasks /></Layout>} />
        </Routes>
